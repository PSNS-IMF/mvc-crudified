...
using Psns.Common.Mvc.Crudified.ModelBinders;
using Psns.Common.Mvc.Crudified.Proxies;
using Psns.Common.Persistence.Definitions;

namespace WFQA.Mvc.UnitTests.ModelBinders.CollectionProperties
{
    ...
    public class WhenWorkingWithTheCollectionPropertyModelBinder : BehaviorDrivenDevelopmentCaseTemplate
    {
        ...
        public override void Arrange()
        {
            ...
            DependencyResolverProxy.Resolver = MockDependencyResolver.Object;
        }
